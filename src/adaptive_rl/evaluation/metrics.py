...
class EvaluationMetrics(BaseModel):
    ...
    success_rate: float = Field(0.0, ge=0.0, le=1.0, description="Fraction of episodes reaching target")
    collision_rate: float = Field(0.0, ge=0.0, le=1.0, description="Fraction of episodes ending in collision")
